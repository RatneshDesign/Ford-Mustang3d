...
function Model({ url, scale = 1 }) {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            tl.add("section1")
                .to(groupRef.current.position, { x: 3.5, duration: 1 }, "section1")
                .to(groupRef.current.rotation, { x: -0.2, y: -0.4, z: 0.1, duration: 1 }, "section1")

                .add("section2")
                .to(groupRef.current.position, { x: 1, Y: 1, z: 1, duration: 1 }, "section2")
                .to(groupRef.current.rotation, { x: 1, y: 1.69, duration: 1 }, "section2")

                .add("section3")
                .to(groupRef.current.position, { x: -4, y: 0.4, z: 3, duration: 1 }, "section3")
                .to(groupRef.current.rotation, { x: 1, y: 1.69, z: 0.3, duration: 1 }, "section3")
    ...
    return (
        <>
            ...
            <div id="scroll-section" style={{ height: "500vh" }} className="w-screen flex flex-col">
                ...
                <section id="section4" className="flex h-screen bg-amber-900 justify-start items-center px-[5vw]">
                    <span className="w-[30%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error iure esse doloribus iste impedit fuga tempore voluptates culpa temporibus aspernatur.</span>
                </section>
            </div>
        </>
